          ...
          $(".qt-plus").click(function () {
                    ...
                    $.ajax({
                              ...
                              success: function (response) {
                                        ...
                                        if (
                                                  response.message ===
                                                  "Value added to session array successfully"
                                        ) {
                                                  // Update the quantity displayed on the page
                                                  var quantityElement = el
                                                            .parent()
                                                            .children(".qt");
                                                  var newQuantity =
                                                            parseInt(
                                                                      quantityElement.html()
                                                            ) + 1;
                                                  quantityElement.html(
                                                            newQuantity
                                                  );
                                                  ...
                                                  var fullPriceElement = el
                                                            .parent()
                                                            .children(
                                                                      ".full-price"
                                                            );
                                                  fullPriceElement.addClass(
                                                            "added"
                                                  );
                                                  window.setTimeout(
                                                            function () {
                                                                      fullPriceElement.removeClass(
                                                                                "added"
                                                                      );
                                                                      changeVal(
                                                                                el
          ...
          $(".qt-minus").click(function () {
                    ...
                    $.ajax({
                              ...
                              success: function (response) {
                                        ...
                                        if (
                                                  response.message ===
                                                  "Value removed from session array successfully"
                                        ) {
                                                  var quantityElement = el
                                                            .parent()
                                                            .children(".qt");
