                        ...
                        <div style="border: #4a260b solid 3px ; padding : 25px 10px">
                            ...
                            <div class="">
                                <x-primary-button class="btn btn-primary me-4 "
                                    style="background-color: #54ac75 ; width:75% ; height:50px" x-data=""
                                    x-on:click.prevent="$dispatch('open-modal', 'Join Us as a Trainer')">{{ __('Join Us as a Trainer') }}</x-primary-button>

                                <x-modal name="Join Us as a Trainer" :show="$errors->changePassword->isNotEmpty()" focusable>

                                    <div class="container mt-5">
                                        <h1> Training Volunteer Form</h1>
                                        <form action="{{ route('frontvolunteers.store') }}" method="post"
                                ...
                                <form action="paypal" method="POST" class=" p-5 rounded donation-form"
                                    data-aos="fade-up">
                                    @csrf
                                    ...
                                    <div class="field-icon">
                                        <span>$</span>
                                        <input type="text" placeholder="0.00" id="cont"
                                            class="form-control px-4" name="price" value="1.00">
                                    ...
                                    @if (!Auth::check())
                                        <x-primary-button class="btn btn-primary w-100"
                                            style="color: white ; background-color : #54ac75" x-data=""
                                            x-on:click.prevent="$dispatch('open-modal', 'change-password')">{{ __('donite') }}</x-primary-button>
                                    ...
                                    @endif
                                    @if (Auth::check())
                                        <input type="submit" value="Paypal" class="btn btn-primary w-100"
                                ...
                                <form action="stripe/{{ $id }}" class="  rounded donation-form" method="post"
                                ...
                                font-size: 18px;">
                                    ...
                                    @if (!Auth::check())
                                        <x-primary-button class="btn btn-primary w-100"
                                            style="color: white ; background-color : #54ac75" x-data=""
                                            x-on:click.prevent="$dispatch('open-modal', 'change1')">{{ __('donite') }}</x-primary-button>
