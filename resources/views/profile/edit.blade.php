...
<x-app-layout>
    ...
    <div class="hero overlay hero-profile"  style="background-image: url('{{ asset('images/bg11.png') }}'); height: 500px; background-size: cover; background-repeat: no-repeat;" >
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 text-center">
                    <h1 class="heading mt-6 mb-2" style="color:#fff; font-weight: bolder;" data-aos="fade-up">Your Profile</h1>
                </div>
            </div>
        </div>
    </div>
