            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                              @if ($diffInMinutes < 60)
                              <p class="text-success">Posted before {{ $diffInMinutes }} Minutes</p>
                          @elseif ($diffInMinutes > 60 && $diffInHours < 24)
                              <p class="text-warning">Posted before {{ $diffInHours }} Hours</p>
                          @elseif ($diffInMinutes > 60 && $diffInHours >= 24)
                              <p class="text-danger">Posted before {{ $diffInDays }} days</p>
                          @endif
                            ...
                            <ul class="list-unstyled">
                                <li>Apply Online: Fill out our quick online application form, indicating your interest in
                                    mentoring for the Front-End Foundations project.</li>
                                ...
                                <li>Mentor Match: Once approved, we'll match you with learners eager to participate in the
                                    Front-End Foundations project.</li>
                ...
                <div class="col-lg-6">
                                  ...
                                  <div class="text-muted">
                                      ...
                                      <div class="progress mb-2">
                                          <div class="progress-bar" role="progressbar" style="width: <?php echo $percant; ?>%;"
                                              aria-valuenow="<?php echo $percant; ?>" aria-valuemin="0" aria-valuemax="100">
                                              <?php echo $percant; ?>%
                                          </div>
                                      </div>
                                      <div class="d-flex mb-4 justify-content-between amount">
                                          <div>@php echo "$" . $totalsproduct; @endphp</div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('frontform') }}" class="btn btn-primary mb-3 d-block " style="width: 80%; margin:auto">Join us as a
                                trainer</a>
                            <a href="{{ route('payment') }}" class="btn btn-primary d-block" style="width: 80%; margin:auto">Donate</a>
                        </div>
                    </div>
