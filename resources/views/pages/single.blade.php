           ...
           ">
                        ...
                        <div style="border: #4a260b solid 3px ; padding : 25px 10px">
                            ...
                            <div class="">
                                    ...
                                    <div class="container mt-5">
                                        ...
                                        <form action="{{ route('frontvolunteers.store') }}" method="post"
                                            ...
                                            <div class="form-group">
                                                <label for="programmingLanguages">Proficient Frontend Programming
                                                    Languages</label>
                                ...
                                <form action="{{ route('paypal') }}" method="POST" class=" p-5 rounded donation-form"
                                    data-aos="fade-up">
                                    @csrf
                                    ...
                                    <div class="field-icon">
                                        <span>$</span>
                                        <input type="text" placeholder="0.00" class="form-control px-4"
                                ...
                                <form action="{{ route('stripe') }}" class="  rounded donation-form" method="post"
