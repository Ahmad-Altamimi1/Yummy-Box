    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('trainees.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <label for="warning"><small>While we are truly grateful for your eagerness to contribute, it's important to note that this specific training program is designed exclusively for individuals facing financial hardships. As such, we kindly ask that those who do not meet this criterion refrain from applying at this time.</small></label>
            </div>
            <div class="form-group">
                <label for="document">If you have any verification document indicating your need for this training, kindly upload it here. </label>
